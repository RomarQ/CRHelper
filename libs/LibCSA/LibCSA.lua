...
function lib:CreateCountdown(displayTimeMs, soundId, endIcon, mainText, secondaryText, setupCallback, countdownCallback)
	local messageParams = CSA:CreateMessageParams(CSA_CATEGORY_MAJOR_TEXT, soundId)
	--messageParams:SetLifespanMS(5000)
	messageParams:SetText("Timer1")
	...
	local messageParams2 = CSA:CreateMessageParams(CSA_CATEGORY_MAJOR_TEXT, soundId)
	--messageParams2:SetLifespanMS(5000)
	messageParams2:SetText("dsadsa")
	--messageParams2:SetIconData(endIcon)
	--messageParams2:SetCSAType(CENTER_SCREEN_ANNOUNCE_TYPE_COUNTDOWN)
	--messageParams2:SetSetupCallback(setupCallback)
	--messageParams2:SetCountdownCallback(countdownCallback)
